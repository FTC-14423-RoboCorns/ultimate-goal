...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.6; // in; distance between the left and right wheels (USED TO BE 14 - Dylan)
    public static double FORWARD_OFFSET = 2; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;
    public static double X_MULTIPLIER = 1.0059; //1.0163 was old

...
public class LeagueTournamentAuton extends OpMode {
 ...
 //   double shootY;
    ...
    */
    private static final double POWEROFFSET = Math.toRadians(1);// Math.toRadians(1)*-1;
...
*/
            ...
            //B
               ...
               // autonPath.trajectory2Array[1] = robot.drive.trajectoryBuilder(getCurrentP(autonPath.firstShotArray[1],autonPath.firstAngleArray[1],autonPath.currentTargetArray[1]))
                     ...
                     */
                   .lineToSplineHeading(new Pose2d(21.0,-32.0,Math.toRadians(175.0)))
